...
public abstract class GameObject  {
    ...
    private float m_frames_state=0;
    private float m_frames_step=0;
...
//    }
    ...
    public void setM_frames_state(float m_frames_state) {
    ...
    public void setM_frames_step(float m_frames_step) {
        this.m_frames_step = m_frames_step;
    }
...
//    }
    ...
    public float getM_frames_state() {
    ...
    public int getM_frames_step() {
        m_frames_step=m_frames_step%1;
        m_frames_step=m_frames_step+m_frames_state;
        return (int)m_frames_step;
    }
